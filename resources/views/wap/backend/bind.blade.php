...
<div class="login_bg">
    ...
    <form class="form-signin" action="{{route('wap.bind_admin.post')}}" method="POST" role="form">
        {{ csrf_field() }}
        @include('flash::message')
        <div class="usernmb">
            <lable>管理员邮箱：</lable>
            <input type="text" name="email" placeholder="请输入管理员邮箱号"  required/>
        </div>
        ...
        <button class="login_btn" type="submit">绑&nbsp;&nbsp;定</button>
    </form>
