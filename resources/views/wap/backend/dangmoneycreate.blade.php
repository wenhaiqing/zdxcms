...
@section('content')
    ...
    <form class="layui-form layui-form-pane" method="POST" action="{{ $dang_money->id ? route('wap.admin_dangmoney_update', ['id'=>$dang_money->id]) : route('wap.admin_dangmoney_store') }}">
        {{ csrf_field() }}
