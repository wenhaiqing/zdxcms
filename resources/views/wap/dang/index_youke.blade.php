...
<ul class="body-ula">
    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/logo10.jpg')}}"/>
            <div>每日签到</div></a>
    </li>
    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/logo11.jpg')}}"/>
            <div>我的支部</div></a>
    </li>
    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/logo12.jpg')}}"/>
            <div>个人中心</div></a>
    </li>

    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/hsez_04.jpg')}}"/>
            <div>通知公告</div></a>
    </li>
    <li>
    ...
    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/hsez_07.jpg')}}"/>
            <div>主题党日</div></a>
    </li>
    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/hsez_08.jpg')}}"/>
            <div>三会一课</div></a>
    </li>
    <li>
    ...
    <li>
        <a href="{{route('wap.lmap')}}"><img src="{{asset('wap/new/images/hsez_11.jpg')}}"/>
            <div>数据中心</div></a>
    </li>
