        ...
        <div class="col-xs-12 clearPadding">
            ...
            <div class="calendar">
                ...
                <div class="text-center">
                    @if($if_sign ==1)
                    <button class="btn btn-qiandao if_sign">已签到</button>
                        @else
                        <button class="btn btn-qiandao no_sign" onClick="signIn()">马上签到</button>
                    @endif
                </div>
            </div>
