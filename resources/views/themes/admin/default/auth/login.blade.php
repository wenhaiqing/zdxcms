        ...
        <div class="layui-col-md4 layui-col-md-offset4">
            <div class="grid-login">
                <div class="login-form">
                    <form class="layui-form layui-form-pane"  method="POST" action="{{ route('auth.login') }}">
                        {{ csrf_field() }}
...
@include('themes.admin.default.layouts._message')

@include('themes.admin.default.layouts._error')
